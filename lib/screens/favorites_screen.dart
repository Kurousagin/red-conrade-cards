...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final favCards =
        gp.allCards.where((c) => gp.favorites.contains(c.id)).toList();
          ...
          children: [
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                gradient:
                    LinearGradient(colors: [SC.redDark, Color(0xFF4A0000)]),
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        const Text('❤️ GALERIA FAVORITA ❤️',
                            style: TextStyle(
                              fontFamily: 'Oswald',
                        ...
                        Text('${favCards.length} cartas favoritas',
                            style:
                                const TextStyle(fontSize: 11, color: SC.cream)),
                      ],
                    ),
                  ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              _confirmClear ? SC.red : const Color(0xFF330000),
                          border: Border.all(
                              color: _confirmClear ? SC.redLight : SC.redDark),
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            fontWeight: FontWeight.w700,
                            fontSize: 11,
                            color: _confirmClear ? Colors.white : SC.red,
                            letterSpacing: 0.5,
                          ),
                        ),
                      ),
