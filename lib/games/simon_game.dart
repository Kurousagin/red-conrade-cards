...
class _SimonGameState extends State<SimonGame> {
  ...
  void _press(int i) {
    ...
    if (_player[idx] != _sequence[idx]) {
      setState(() => _phase = SimonPhase.lose);
      return;
    }
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_phase != SimonPhase.idle &&
                      _phase != SimonPhase.win &&
                      _phase != SimonPhase.lose)
                    _levelDots(),
                  if (_phase == SimonPhase.idle)
                    Padding(
  ...
  Widget _statusText() {
    ...
    switch (_phase) {
      case SimonPhase.idle:
        text = 'Memorize a sequência!\n5 níveis para vencer';
      case SimonPhase.showing:
        text = '👁️ Observe a sequência...';
      case SimonPhase.input:
        text = '🎯 Repita! (${_player.length}/${_sequence.length})';
      default:
        text = '';
    }
    return Padding(
        ...
        children: List.generate(
            ...
            (i) => Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: i < _level ? SC.gold : const Color(0xFF666666),
                        width: 2),
                  ),
                )),
      );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
              won
                  ? 'Sequência completa de 5 níveis!'
                  : 'Errou no nível $_level',
